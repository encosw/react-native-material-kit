...
} from "../internal/textfield/FloatingLabel";
import Underline, {
    UnderlinePublicProps,
} from "../internal/textfield/Underline";
...
> {
    ...
    isFocused(): boolean {
        return (
            (this.inputRef.current && this.inputRef.current.isFocused()) ===
            true
        );
    }
    ...
    render() {
        ...
        const floatingLabel = this.props.floatingLabelEnabled ? (
            <FloatingLabel
                ...
                highlightColor={
                    this.props.highlightColor || tfTheme.highlightColor
                }
                floatingLabelFont={
                    this.props.floatingLabelFont || tfTheme.floatingLabelFont
                }
            />
        ) : null;
        const underline = (
    ...
    private _aniFloatLabel() {
        if (
            this.bufferedValue &&
            this.props.floatingLabelEnabled &&
        ...
        if (this.underlineRef.current && this.labelRef.current) {
            ...
            this.startAnimations(
                [
                    ...
                    ...(!this.bufferedValue
                        ? this.labelRef.current.aniSinkLabel()
